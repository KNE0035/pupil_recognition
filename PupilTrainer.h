...
const int MINIMUM_IMG_DIM_SIZE = 320;
...
public:
	PupilTrainer(double startingLearningRate,
		...
		bool verboseMode,
		MmodDatasetLoader* mmodDataLoader) : MmodTrainer<pupil_detection_net_type>(startingLearningRate, syncFile, outputNetworkFile, minimumLearningRate, iterationWithoutProgressTreshold, (new chip_dims(2 * MINIMUM_IMG_DIM_SIZE, 2 * MINIMUM_IMG_DIM_SIZE)), false, 0, verboseMode, mmodDataLoader, 5)
